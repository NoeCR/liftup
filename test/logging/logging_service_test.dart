...
import 'package:liftly/core/logging/logging_service.dart';
  ...
  group('LoggingService', () {
    ...
    test('should log errors with stack trace', () {
      try {
        ...
        expect(
          () => loggingService.error('Test error', e, stackTrace),
          returnsNormally,
        );
      }
    });
    ...
    test('should add breadcrumbs', () {
      expect(
        () => loggingService.addBreadcrumb('Test breadcrumb'),
        returnsNormally,
      );
    });
    ...
    test('should set tags', () {
      expect(
        () => loggingService.setTag('test_tag', 'test_value'),
        returnsNormally,
      );
    });
    ...
    test('should set context', () {
      expect(
        () => loggingService.setContext('test_context', {'key': 'value'}),
        returnsNormally,
      );
    });
  });
