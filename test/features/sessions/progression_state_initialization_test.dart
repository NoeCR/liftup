...
void main() {
  group('Progression State Initialization Tests', () {
    ...
    test(
      'should collect and use highest values when initializing progression state from session data',
      () async {
    ...
    test(
      'should not initialize progression state when existing state already exists',
      () async {
    ...
    test(
      'should handle multiple exercises correctly in session completion',
      () async {
