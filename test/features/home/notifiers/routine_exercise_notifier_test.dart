...
void main() {
  group('RoutineExerciseNotifier', () {
    test('addExercisesToSection agrega ejercicios en la sección seleccionada', () async {
      final container = ProviderContainer();
      addTearDown(container.dispose);

      final notifier = container.read(routineExerciseNotifierProvider.notifier);
      ...
      final updatedA = container.read(routineExerciseNotifierProvider)[sectionIdA]!;
