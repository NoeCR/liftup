  ...
  group('Refactored Architecture Integration Tests', () {
    ...
    group('AdaptiveIncrementConfig Integration', () {
      test('getIncrementValueSync uses AdaptiveIncrementConfig correctly', () {
        ...
        // Para barbell multi-joint (intermediate), el recomendado es 5.0
      ...
      test('getMinRepsSync uses AdaptiveIncrementConfig correctly', () {
        ...
        // Debería usar el valor de la configuración (3)
      ...
      test('getBaseSetsSync uses AdaptiveIncrementConfig correctly', () {
        ...
        // Debería usar el valor de la configuración (5)
        expect(baseSets, equals(5));
      });
    });
    ...
    group('ExerciseProgressionConfig Integration', () {
      test(
        ...
        () async {
          ...
          // Debería usar AdaptiveIncrementConfig (6.25) ya que no hay servicio
          expect(increment, equals(6.25));
        },
      );
    ...
    group('ExperienceLevel Integration', () {
      ...
      test('AdaptiveIncrementConfig uses ExperienceLevel correctly', () {
        ...
        expect(barbellIncrement, equals(3.75)); // Barbell multi-joint
        // Para isolation dumbbell (intermediate) el recomendado actual es 1.625
        expect(dumbbellIncrement, equals(1.625));
      });
    });
