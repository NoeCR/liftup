...
void main() {
  group('DoubleFactorProgressionStrategy (Doble Progresión)', () {
    ...
    test('incrementa peso en semana impar (semana 1)', () {
      ...
      expect(result.newWeight, 76.0); // Peso incrementa en 6.0kg (semana impar, barbell multiJoint, nivel intermedio)
    ...
    test('usa valores por defecto cuando no hay parámetros personalizados', () {
      ...
      expect(result.newWeight, 76.0); // incrementValue adaptativo (6.0kg para barbell multiJoint, nivel intermedio)
