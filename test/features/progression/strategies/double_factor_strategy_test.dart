    ...
    test(
      ...
      () {
        ...
        expect(
          ...
          6,
        ); // Semana 2 (par): 6 -> 6 reps (incrementa reps)
        expect(
          firstCycle[2]['newReps'],
          6,
        ); // Semana 3 (impar): 6 -> 6 reps (mantiene, incrementa peso)
        expect(
          firstCycle[3]['newReps'],
          6,
        ); // Semana 4 (par): 6 -> 6 reps (incrementa reps)
        expect(
          firstCycle[4]['newReps'],
          6,
        ); // Semana 5 (impar): 6 -> 6 reps (mantiene, incrementa peso)
        expect(
