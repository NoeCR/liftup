...
void main() {
  group('Deload Blocking Tests', () {
    ...
    test('linear progression: blocking during deload preserves baseSets', () {
      ...
      expect(result.newSets, 3); // Debe usar baseSets del sistema adaptativo (3), no currentSets (3)
    ...
    test('normal progression after deload blocking restores to baseSets', () {
      ...
      expect(result.newSets, 4); // Debe restaurar a baseSets del sistema adaptativo
