...
class ProgressionMockFactory {
  ...
  static ProgressionTemplate createProgressionTemplate({
    ...
    String? whenToUse,
    String? deloadExplanation,
    String? progressionExplanation,
    ...
    return ProgressionTemplate(
      ...
      deloadPercentage: deloadPercentage ?? 0.9,
      customParameters: customParameters ?? {},
      detailedDescription: detailedDescription ?? 'Test detailed description',
      whenToUse: whenToUse ?? 'Test when to use',
      deloadExplanation: deloadExplanation ?? 'Test deload explanation',
      progressionExplanation: progressionExplanation ?? 'Test progression explanation',
      benefits: benefits ?? ['Test benefit'],
      considerations: considerations ?? ['Test consideration'],
      estimatedDuration: estimatedDuration ?? 8,
      difficulty: difficulty ?? 'medium',
      targetAudience: targetAudience ?? ['beginner', 'intermediate'],
    );
  }
