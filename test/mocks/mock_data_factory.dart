...
class MockDataFactory {
  ...
  static List<Exercise> _generateMockExercises() {
    ...
    return mockData.map((data) => Exercise(
  ...
  static List<MuscleGroup> _parseMuscleGroups(List<String> muscleGroupStrings) {
    return muscleGroupStrings.map((group) {
      switch (group.toLowerCase()) {
        case 'pecho': return MuscleGroup.pectoralMajor;
        case 'hombros': return MuscleGroup.anteriorDeltoid;
        case 'tríceps': return MuscleGroup.tricepsLongHead;
        case 'cuádriceps': return MuscleGroup.rectusFemoris;
        case 'glúteos': return MuscleGroup.gluteusMaximus;
        case 'isquiotibiales': return MuscleGroup.bicepsFemoris;
        case 'dorsales': return MuscleGroup.latissimusDorsi;
        case 'bíceps': return MuscleGroup.bicepsLongHead;
        case 'deltoides posterior': return MuscleGroup.posteriorDeltoid;
        default: return MuscleGroup.pectoralMajor;
      }
    }).toList();
  }
