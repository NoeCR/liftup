...
class SessionMockGenerator {
  ...
  static List<WorkoutSession> generateLast4WeeksSessions() {
    ...
    return sessions.reversed.toList(); // Ordenar cronológicamente
  }
  ...
  static WorkoutSession _generateSessionForDay(DateTime day, int dayIndex) {
    ...
    exerciseSets.addAll(_generateSetsForExercise(
      _exerciseId1,
      benchPressWeight,
      benchPressReps,
      startTime,
    ...
    return WorkoutSession(
      ...
      notes: null,
      totalWeight: exerciseSets.fold<double>(0, (sum, set) => sum + (set.weight * set.reps)),
