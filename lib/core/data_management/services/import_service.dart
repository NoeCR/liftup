...
class ImportService {
  ...
  Future<ImportResult> importFromFile({required String filePath, required ImportConfig config}) async {
    return await PerformanceMonitor.instance.monitorAsync('import_from_file', () async {
      try {
        ...
        return ImportResult.failure(errorMessage: 'Error during import: $e', errors: ['Service error: $e']);
      }
    }, context: {'file_path': filePath, 'config_type': config.runtimeType.toString()});
  }
